...
public class Swapper{
	...
	s += keyboard.readInt();
	s += keyboard.readInt();
	int selectedRow = Integer.parseInt(s.substring(s.length()-2,s.length()-1));
	int selectedCell = Integer.parseInt(s.substring(s.length()-1,s.length()));
	...
	s += keyboard.readInt();
	s += keyboard.readInt();
	int newRow = Integer.parseInt(s.substring(s.length()-2,s.length()-1));
	int newCell = Integer.parseInt(s.substring(s.length()-1,s.length()));
