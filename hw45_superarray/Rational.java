...
public class Rational implements Comparable
{
  ...
  public boolean equals( Object other )
  {
    ...
    //...thus allowing for direct comparison of attributes
      ...
      if (other instanceof Rational){ // checks if other is an instance of class Rational
	  reduce();
	  ((Rational)other).reduce(); // typecasts other into a Rational
	  // return boolean of memory locations of this and other being the same
	  // or if their numerators and denominators are equivalent
  ...
  public int compareTo( Object other )
  {
    ...
    // This will exit the function, generating a runtime error
      ...
      Rational temp = new Rational(this._numerator, this._denominator); // creates temporary instance of Rational storing current _numerator and _denominator values
      
      try{
	  temp.subtract((Rational) other); 
	  if (! (other instanceof Rational)){ // if other is not an instance of Rational throw exception
	      throw new Exception();
	  }
      }
      catch (Exception e){
	  System.out.println("Run Time Error: inputted Object is not an instance of class Rational..."); // if exception was thrown then print this message
	  System.out.println("\nReturning designated error int");
	  return Integer.MIN_VALUE;
      }
      return temp._numerator; 
